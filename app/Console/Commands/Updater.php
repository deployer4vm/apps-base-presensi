...
class Updater extends Command
{
    ...
    protected $signature = 'syndeploy:update '
        ...
        . '{--module= : [OPTIONAL] update package module-module yang dicantumkan '
            . ', format :  moduleNamespace1,moduleNamespace2} '
    ...
    public function handle()
    {
        ...
        if (File::put(
                ...
                str_replace('\/', '/', json_encode($composerJson, JSON_PRETTY_PRINT))
        )) {

    ...
    <div>
        <div class="row mb-3">
            ...
            <div class="col text-right">
                <b-btn class="btn-sm w-icon" @click="requestDownload" :class="config.btnVariant" :disabled="downloadStatus.status==1 || downloadStatus.status==2">
                    <i class="fi fi-rs-cloud-download"></i>
                    <span> {{ Trans.get('lang.export.label.generate_new') }}</span>
                </b-btn>
            </div>
        </div>
